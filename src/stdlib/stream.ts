...
// // export function* stream(...elements: Thunk[]): Stream {
// //   return yield* list_to_stream(list(...elements))
// // }
// //
// // export function list_to_stream(xs: List): Stream {
// //   return is_null(Thunk.from(xs))
// //     ? null
// //     : pair(head(Thunk.from(xs)), () => list_to_stream(yield * tail(Thunk.from(xs))))
// // }
